# Mostly referring to "edgeR: differential analysisof sequence read count dataUser’s Guide" Chapter 4.4.
...
design <- model.matrix(~ 0 + reg:dw) #This is excatly same as above model.
design
